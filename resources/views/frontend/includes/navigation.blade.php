<header class="page_header header_color template_header {{(!isset($homepage)) ? 'subpage_header' : ''}} table_section toggle_menu_left">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                            ...
                            <ul class="mainmenu nav sf-menu">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="team-single.html">Member Profile</a>
                                        </li>
                                    </ul>
                                </li>
