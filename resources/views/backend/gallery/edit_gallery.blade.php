                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="container-fluid">
                                <form id="edit_form" class="form-horizontal" method="POST" action="{{ route('updategallery', ['id' => $gallery->id]) }}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    {{ method_field('PATCH') }}
                                    <div class="row">
                                        ...
                                        <div class="col-md-11">
                                            <div class="form-group label-floating is-empty">
                                                <input type="text" name="name" class="form-control" value="{{ $gallery->name }}" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
