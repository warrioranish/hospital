...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form name="content-list" id="content-list" action="{{ route('actionsliders') }}" method="POST">
                        {{ csrf_field() }}
                        <div class="card">
                                            ...
                                            @foreach($sliders as $s)
                                                <tr>
                                                    ...
                                                    <td class="td-actions">
                                                        ...
                                                        <button type="button" rel="tooltip" class="btn btn-danger btn-round delete-slider" title="delete slider" data-href="{{ url('admin/sliders/delete/'.$s->id) }}"><i class="material-icons">delete</i></button>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @else
                ...
                if($(".selectpicker").val() == '') {
                    ...
                    if ($(".flag-check:checked").length < 1) {
                        ...
                        if($(".selectpicker").val() == 'publish'){
                            var text = "You really want to publish selected sliders?";
                        } else if($(".selectpicker").val() == 'unpublish'){
                            var text = "You really want to unpublish selected sliders?";
                        } else {
                            var text = "You really want to delete selected sliders?";
                            var type = "warning";
                        }
