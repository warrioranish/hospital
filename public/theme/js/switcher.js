...
var switcherHTML = '<div id="switcher">';
		...
		switcherHTML +=    		'<div class="checkbox checkbox-sliders--b-flat">';
		switcherHTML +=    		    '<label>';
		switcherHTML +=    		        '<input type="checkbox" id="layouts"> <span>Boxed</span>';
		switcherHTML +=    		    '</label>';
		switcherHTML +=    		'</div>';
		switcherHTML +=    		'<div class="checkbox checkbox-sliders--b-flat">';
        ...
        //boxed or wide
        jQuery('#layouts').on('click', {patterns: patternClasses}, switcherClass.switchBoxedWide);
        ...
        //if cookies set - changing layouts
        if (cookieClass.returnTrueOrFalseCookie('boxed')) {
        	...
        	jQuery('#layouts').prop('checked', true);
...
var switcherClass = {
	...
	switchBoxedMargins : function  ( e ) {
		if(jQuery('#layouts').prop('checked')) {
	...
	switchDarkLight: function ( e ) {
		...
		jQuery("#box_wrapper > *").each(function() {
			...
			if (
				...
				|| jQuery(this).hasClass('page_services') 
				|| jQuery(this).hasClass('page_testimonials')
				|| jQuery(this).hasClass('features')
